...
Impulse_bit=0.5*firing_period; % 0.5 is desired thrust (in space) plus friction on Earth. %%%%%%%program test data=40*(10^-6)
thrust_M=Impulse_bit/firing_period*(l/2)*(3/4); % moment produced by thruster %%%%%%%program test data(arm)=0.14
on_duration_min=0.03;
off_duration_min=0.03;
